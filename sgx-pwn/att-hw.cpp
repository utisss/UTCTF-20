...
int main(int argc, char** argv) {
		...
		enclave_status = sgx_create_enclave("enclave.signed.so", 1, &token, &updated, &eid, NULL);
		...
		int pop_rdi = 0x0000000000003b70;
		int pop_rsi = 0x0000000000004286;
		int pop_rdx_rcx = 0x00000000000c933;
		int enclave_exit = 0;
		...
		int ocall_load_data = 0x3125;
		int unseal_data = 0x3609;
		int ocall_save_data = 0x2fa8;
