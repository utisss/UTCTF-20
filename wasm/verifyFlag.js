...
function win(str){ var flag = UTF8ToString(str); document.write("<center>Congratulations! The flag is: " + flag + "</center>"); }
function getString(str){ var retVal = eval(UTF8ToString(str)); var length = lengthBytesUTF8(retVal)+1; var result = _malloc(length); stringToUTF8(retVal, result, length); return result; }
function lose(){ document.write("<center>Try again!</center>"); }
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "__lock": ___lock, "__unlock": ___unlock, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_resize_heap": _emscripten_resize_heap, "getString": getString, "lose": lose, "memory": wasmMemory, "table": wasmTable, "win": win };
var asm = createWasm();
Module["asm"] = asm;
...
var _aes_encrypt_block = Module["_aes_encrypt_block"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["aes_encrypt_block"].apply(null, arguments)
};

var ___em_js__getString = Module["___em_js__getString"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__getString"].apply(null, arguments)
};

var ___em_js__win = Module["___em_js__win"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__win"].apply(null, arguments)
};

var ___em_js__lose = Module["___em_js__lose"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__lose"].apply(null, arguments)
};

var _verify_flag = Module["_verify_flag"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["verify_flag"].apply(null, arguments)
};
